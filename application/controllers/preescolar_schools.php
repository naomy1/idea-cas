<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Preescolar_schools extends CI_Controller {
		...
		public function index () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
					...
					$schools_data = array(
						'schools'		=> $this->preescolar_schools_mdl->getUserSchools($this->session->userdata('cas-preescolar-userid'))
					);
					
					$this->load->view('preescolar/dashboard/dashboard-teacher-schools-index', $schools_data);
			...
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
					...
					$addschool_data = array(
						'addschool_delegations' => $this->preescolar_schools_mdl->getDelegations()
					);
					
					$this->load->view('preescolar/schools/windows/windows-addschool', $addschool_data);
		...
		public function addschool_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
					...
					// end: validations
					$this->load->view('preescolar/schools/windows/windows-addschool-messenger', $addschoolattempt_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function deleteSchool_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
					...
					$this->load->model('preescolar_schools_mdl');
					$this->preescolar_schools_mdl->deleteSchool($schoolID);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
			...
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
					...
					$editSchool_data = array(
						...
						'editschool_delegations'				=> $this->preescolar_schools_mdl->getDelegations()
					);
					
					$this->load->view('preescolar/schools/windows/windows-editschool', $editSchool_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function editSchool_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
					...
					$this->load->view('preescolar/schools/windows/windows-editschool-messenger', $editSchoolAttempt_data);
