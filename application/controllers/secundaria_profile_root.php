<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Secundaria_profile_root extends CI_Controller {
		...
		public function __construct () {
			...
			$this->load->model('secundaria_users_mdl',			'users');
		...
		public function index () {
			...
			if ( $this->input->is_ajax_request() ) {
				...
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					$this->load->view('secundaria/dashboard/root/root-index');
				}
				else
		...
		public function schools () {
			if ( $this->input->is_ajax_request() ) {
				...
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-schools', $schools_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
			...
			if ( $this->input->is_ajax_request() ) {
				...
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$questions_data = array(
						'questions' => $this->qa->get_questions()
					);
					
					$this->load->view('secundaria/dashboard/root/root-questions', $questions_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function apps () {
			if ( $this->input->is_ajax_request() ) {
				...
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-apps-index', $apps_data);
		...
		public function users () {
			if ( $this->input->is_ajax_request() ) {
				...
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-users', $users_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function window_edit_school () {
			if ( $this->input->is_ajax_request() ) {
				...
				$schoolInfo = $this->schools->getSchoolInfo($this->input->post('schoolid'));
					...
					$this->load->view('secundaria/dashboard/root/root-edit-school', $editSchool_data);
		...
		public function edit_school_attempt () {
			...
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-edit-school-messenger', $editSchoolAttempt_data);
			...
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$window_add_question_data = array(
						...
						'question_type'		=> $this->qa->get_question_types(3)
					);
					
					$this->load->view('secundaria/dashboard/root/root-add-questions-window', $window_add_question_data);
		...
		public function window_add_app_question_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-add-questions-window-messenger', $window_edit_question_attempt_data);
			...
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$window_edit_question_data = array(
						'question' => $this->secundaria_qa_mdl->get_question($this->input->post('question_id'))
					);
					
					$this->load->view('secundaria/dashboard/root/root-edit-questions-window', $window_edit_question_data);
			...
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					if ( strlen(trim($this->input->post('question_content'))) <= 0 ) {
						...
						$this->load->model('secundaria_qa_mdl');
						$this->secundaria_qa_mdl->update_question($this->input->post('question_id'), $question_update);
						$window_edit_question_attempt_data['msg_type']		= 'success';
						$window_edit_question_attempt_data['msg_content']	= 'la pregunta se actualizó correctamente';
					}
					
					$this->load->view('secundaria/dashboard/root/root-edit-questions-window-messenger', $window_edit_question_attempt_data);
		...
		public function students () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->model('secundaria_schools_mdl');
					$schools_data = array(
						'schools'		=> $this->secundaria_schools_mdl->getAllSchools()
					);
					
					$this->load->view('secundaria/dashboard/root/root-schools-students-index', $schools_data);
		...
		public function students_groups () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-groups-index', $index_data);
		...
		public function students_groups_lists () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-students-index', $group_list_data);
		...
		public function upgrade_schools_students () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-upgrade_schools_students-window');
		...
		public function upgrade_schools_students_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-upgrade_schools_students-window-messenger', $upgrade_schools_students_attempt_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function upgrade_schools_groups () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-upgrade_schools_groups-window', $upgrade_schools_groups_data);
		...
		public function upgrade_schools_groups_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-upgrade_schools_groups-window-messenger', $upgrade_schools_groups_students_attempt_data);
		...
		public function edit_student () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-windows-editstudent', $editstudent_data);
		...
		public function edit_student_get_school_groups () {
			...
			$this->load->view('secundaria/dashboard/root/root-windows-editstudent-messenger-groups', $edit_student_get_school_groups_data);
		}
		...
		public function editstudent_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
							...
							if ( $studentInto_curp ) {
								if ( $studentInfo->student_id == $studentInto_curp->student_id ) {
									...
									if ( $studentInto_curp->student_is_deleted != 'false' || $studentInto_curp->student_is_down != 'false' ) {
										...
										if ( $this->secundaria_students_mdl->updateStudent_root($this->input->post('studentID'), $editstudentattempt_info) ) {
											$editstudentattempt_data['msg_type']		= 'success';
											$editstudentattempt_data['msg_content']		= 'la información del alumno se actualizo correctamente';
										}
										else{
					...
					$this->load->view('secundaria/dashboard/root/root-windows-editstudent-messenger', $editstudentattempt_data);
		...
		public function upgrade_schools_groups_students () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-upgrade_schools_groups_students-window', $upgrade_schools_groups_students_data);
		...
		public function upgrade_schools_groups_students_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-upgrade_schools_groups_students-window-messenger', $upgrade_schools_groups_students_attempt_data);
		...
		public function add_school () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-addschool-windows', $addschool_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function addschool_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					// end: validations
					$this->load->view('secundaria/dashboard/root/root-addschool-messenger-window', $addschoolattempt_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function add_school_group_student () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/root-addschool-addgroup-addstudent-window.php', $add_school_group_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function window_addstudent () {
			...
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/windows-add-student', $addstudent_data);
		...
		public function addstudent_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/windows-add-student-messenger', $addstudentattempt_data);
		 ...
		 public function window_addgroup () {
		 	if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ){
					...
					$this->load->view('secundaria/dashboard/root/root-windows-groups-addgroup', $addgroup_data);
		  ...
		  public function addgroup_attempt () {
		  	if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ){
					...
					$this->load->view('secundaria/dashboard/root/root-windows-groups-addgroup-messenger', $addgroupattempt_data);
		...
		public function window_editgroup ($groupID = 0) {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ){
					...
					$this->load->view('secundaria/dashboard/root/root-windows-groups-editgroup', $editgroup_data);
		...
		public function editgroup_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ){
					...
					$this->load->view('secundaria/dashboard/root/root-windows-groups-editgroup-messenger', $editgroup_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function useredit () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->model('secundaria_users_mdl');
					$useredit_info = $this->secundaria_users_mdl->get_userData_by_ID($this->input->post('userid'));
					$useredit_data = array(
					...
					$this->load->view('secundaria/dashboard/root/window-user-edit-profile', $useredit_data);
			...
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					elseif ( strlen(trim($usereditattempt_info['user_fname'])) > 0 && strlen(trim($usereditattempt_info['user_lname'])) > 0 && $this->strings_mdl->is_email($usereditattempt_info['user_email']) && $this->strings_mdl->is_curp($usereditattempt_info['user_curp']) && strlen(trim($usereditattempt_info['user_usaer'])) > 0 && strlen(trim($usereditattempt_info['user_usaer_supervision_zone'])) > 0 && $usereditattempt_info['user_crosee'] > '0' ) {
						...
						$userinfo = $this->secundaria_users_mdl->get_userData_by_ID($this->input->post('userid'));
						...
						if ( $userinfo->user_email == $usereditattempt_info['user_email'] && strtolower($userinfo->user_curp) == strtolower($usereditattempt_info['user_curp']) ) {
							...
							// update
							if ( $this->secundaria_users_mdl->updateUserData($this->input->post('userid'), $usereditattempt_info) == 200 ) {
							...
							// update
							if ( !$this->secundaria_users_mdl->email_exists($usereditattempt_info['user_email']) && !$this->secundaria_users_mdl->curp_exists($usereditattempt_info['user_curp']) ) {
								if ( $this->secundaria_users_mdl->updateUserData($this->input->post('userid'), $usereditattempt_info) == 200 ) {
									$usereditattempt_data['msg_type']		= 'success';
									$usereditattempt_data['msg_content']	= 'su información ha sido actualizada correctamente';
								}
							...
							// no update
							elseif ( $userinfo->user_email != $usereditattempt_info['user_email'] && $this->secundaria_users_mdl->email_exists($usereditattempt_info['user_email']) ) {
								$usereditattempt_data['msg_type']		= 'error';
								$usereditattempt_data['msg_content']	= 'el correo ya ha sido registrado por otro usuario';
							}
							
							// no update
							elseif ( $userinfo->user_curp != $usereditattempt_info['user_curp'] && $this->secundaria_users_mdl->curp_exists($usereditattempt_info['user_curp']) ) {
								$usereditattempt_data['msg_type']		= 'error';
								$usereditattempt_data['msg_content']	= 'la C.U.R.P. ya ha sido registrada por otro usuario';
							}
							
							// update
							elseif ( $userinfo->user_email == $usereditattempt_info['user_email'] && $userinfo->user_curp != $usereditattempt_info['user_curp'] && !$this->secundaria_users_mdl->curp_exists($usereditattempt_info['user_curp']) ) {
								if ( $this->secundaria_users_mdl->updateUserData($this->input->post('userid'), $usereditattempt_info) == 200 ) {
									$usereditattempt_data['msg_type']		= 'success';
									$usereditattempt_data['msg_content']	= 'su información ha sido actualizada correctamente';
								}
							...
							// update
							elseif ( $userinfo->user_curp == $usereditattempt_info['user_curp'] && $userinfo->user_email != $usereditattempt_info['user_email'] && !$this->secundaria_users_mdl->email_exists($usereditattempt_info['user_email']) ) {
								if ( $this->secundaria_users_mdl->updateUserData($this->input->post('userid'), $usereditattempt_info) == 200 ) {
									$usereditattempt_data['msg_type']		= 'success';
									$usereditattempt_data['msg_content']	= 'su información ha sido actualizada correctamente';
								}
					...
					$this->load->view('secundaria/dashboard/root/window-user-edit-profile-messenger', $usereditattempt_data);
		...
		public function delete_user ( ) {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->db->update('app', array('app_user_id' => $this->session->userdata('cas-secundaria-userid')));
					
					$this->db->where('answer_user_id', $this->input->post('userid'));
					$this->db->update('app_answers', array('answer_user_id' => $this->session->userdata('cas-secundaria-userid')));
					
					$this->db->where('question_user_id', $this->input->post('userid'));
					$this->db->update('app_questions', array('question_user_id' => $this->session->userdata('cas-secundaria-userid')));
					
					$this->db->where('school_user_id', $this->input->post('userid'));
					$this->db->update('schools', array('school_user_id' => $this->session->userdata('cas-secundaria-userid')));
					
					$this->db->where('group_user_id', $this->input->post('userid'));
					$this->db->update('schools_groups', array('group_user_id' => $this->session->userdata('cas-secundaria-userid')));
					
					$this->db->where('student_user_id', $this->input->post('userid'));
					$this->db->update('schools_groups_students', array('student_user_id' => $this->session->userdata('cas-secundaria-userid')));
		...
		public function window_add_app () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					$this->load->view('secundaria/dashboard/root/window-add-app');
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function window_add_app_attempt () {
			$add_app_data = array(
				'app_id'				=> 'NULL',
				'app_user_id'			=> $this->session->userdata('cas-secundaria-userid'),
			...
			$this->load->view('secundaria/dashboard/root/windows-add-app-messenger', $add_app_messages);
		}
		...
		public function window_update_app () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					$this->load->view('secundaria/dashboard/root/window-update-app', $window_update_app_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function window_update_app_attempt () {
			...
			$this->load->view('secundaria/dashboard/root/window-update-app-messenger', $add_app_messages);
		}
			...
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {
					...
					if ( $appinfo->app_is_active ) {
						$this->db->where(array('app_id' => $this->input->post('appid'), 'app_school_level' => 3));
						$this->db->update('app', array('app_is_active' => FALSE));
						
					}
					else {
						$this->db->where(array('app_school_level' => 3));
						$this->db->update('app', array('app_is_active' => FALSE));
						$this->db->where(array('app_id' => $this->input->post('appid'), 'app_school_level' => 3));
					...
					$this->load->view('secundaria/dashboard/root/root-toogle-app-status', $toggle_app_status_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
		...
		public function apps_view () {
			if ( $this->input->is_ajax_request() ) {
				...
				if ( $this->session->userdata('cas-secundaria-userid') && $this->session->userdata('cas-secundaria-username') && $this->session->userdata('cas-secundaria-userdashboard') ) {					
					...
					$this->load->view('secundaria/dashboard/root/root-app-view', $apps_view_data);
