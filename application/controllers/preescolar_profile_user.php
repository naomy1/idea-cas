...
class Preescolar_profile_user extends CI_Controller {
	...
	public function index () {
		if ( $this->input->is_ajax_request() ) {
			...
			if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
				...
				$this->load->view('preescolar/dashboard/user/user-index');
			}
			else
	...
	public function schools () {
		if ( $this->input->is_ajax_request() ) {
			if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
				...
				$data_view = array(
					'userSchools' => $this->preescolar_schools_mdl->getUserSchools($this->session->userdata('cas-preescolar-userid'))
				);
				
				$this->load->view('preescolar/dashboard/user/user-schools', $data_view);
	...
	public function window_addme_to_school () {
		if ( $this->input->is_ajax_request() ) {
			if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
				...
				$this->load->view('preescolar/dashboard/user/user-schools-add-school');
	...
	public function window_addme_to_school_attempt () {
		if ( $this->input->is_ajax_request() ) {
			if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
				...
				if ( strlen(trim($this->input->post('cct'))) == 10 ) {
					...
					if ( $this->schools->cct_exists($this->input->post('cct')) ) {
						...
						if ( !empty($school_info) ) {
							...
							$relationship = array(
								'cas_users_user_id'			=> $this->session->userdata('cas-preescolar-userid'),
				...
				$this->load->view('preescolar/dashboard/user/user-schools-add-school-messenger', $data_window_addme_to_school_attempt);
	...
	public function user_school_info () {
		if ( $this->input->is_ajax_request() ) {
			if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
				...
				$this->load->view('preescolar/dashboard/user/user-school-info', $userschoolinfo_data);
