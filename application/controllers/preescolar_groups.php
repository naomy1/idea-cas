<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Preescolar_groups extends CI_Controller {
		...
		public function index () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ) {
					...
					$this->load->view('preescolar/groups/groups-index', $index_data);
		 ...
		 public function window_addgroup () {
		 	if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ){
					...
					$this->load->view('preescolar/groups/windows/windows-groups-addgroup', $addgroup_data);
		  ...
		  public function addgroup_attempt () {
		  	if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ){
					...
					$this->load->view('preescolar/groups/windows/windows-groups-addgroup-messenger', $addgroupattempt_data);
		...
		public function window_editgroup ($groupID = 0) {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ){
					...
					$this->load->view('preescolar/groups/windows/windows-groups-editgroup', $editgroup_data);
		...
		public function editgroup_attempt () {
			if ( $this->input->is_ajax_request() ) {
				if ( $this->session->userdata('cas-preescolar-userid') && $this->session->userdata('cas-preescolar-username') && $this->session->userdata('cas-preescolar-userdashboard') ){
					...
					$this->load->view('preescolar/groups/windows/windows-groups-editgroup-messenger', $editgroup_data);
				}
				else
					$this->load->view('errors/errors-session-ended');
			}
