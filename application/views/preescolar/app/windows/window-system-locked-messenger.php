<?php
	...
	elseif ( $msg_type == 'success' ){
		echo 'contentLoader(\'preescolar_app\', \'index\', \'.dashboard-container\', \'schoolID=\' + ' . $groupInfo['student_school_id'] . ' + \'&schoolCCT=\' + "' . $groupInfo['student_school_cct'] . '" + \'&groupID=\' + ' . $groupInfo['student_group_id'] . ' + \'\', \'schoolID=\' + ' . $groupInfo['student_school_id'] . ' + \'&schoolCCT=\' + "' . $groupInfo['student_school_cct'] . '" + \'&groupID=\' + ' . $groupInfo['student_group_id'] . ' + \'\');';
		echo '
			setTimeout(function () {
				closeWindow();
			}, 6000);
