<?php
	...
	echo '<html lang="en">';
		echo '<head>';
			...
			echo '<title>Sistema de Identificación de Alumnos IdeA-CAS (preescolars)</title>';
			echo '<meta name="description" content="Sistema que ayuda a la Dirección de Educación Especial (DEE) a realizar un sondeo y poder identificar alumnos que tengan capacidades sobresalientes en preescolar, primaria y preescolar." />';
		...
		echo '<script type="text/javascript" src="' . base_url() . 'js/preescolar/jq.functions.js"></script>';
		echo '<script type="text/javascript" src="' . base_url() . 'js/preescolar/jq.code.js"></script>';
		echo '<script type="text/javascript">$(document).ready(function () {contentLoader(\'preescolar\', \'dashboard\');});</script>';
