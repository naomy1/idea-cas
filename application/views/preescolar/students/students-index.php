<?php
	...
	echo '<span class="history-options">';
		echo '<a href="javascript: contentLoader(\'preescolar_groups\', \'index\', \'.dashboard-container\', \'schoolID=' . $schoolInfo->school_id . '\', \'schoolID=' . $schoolInfo->school_id . '\');" class="ho-back">Regresar</a>';
