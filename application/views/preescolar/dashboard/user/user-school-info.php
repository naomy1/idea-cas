	...
	echo '<span class="table table-user-schools-info">';
		...
		echo '<span class="table-header">';
			...
			echo '<span class="header-options">';
				echo '<a href="' . base_url() . '?c=excel&m=preescolar_make_school_excel&schoolID=' . $school_info->school_id . '" class="option-item download-school-format">Descargar formato</a>';
			echo '</span>';
