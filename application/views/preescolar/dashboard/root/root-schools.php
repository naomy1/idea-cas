	...
	echo '<span class="table table-root-schools-info">';
		...
		echo '<span class="table-header">';
			...
			echo '<span class="header-options">';
				echo '<a href="' . base_url() . '?c=excel&m=preescolar_all_nominated" class="option-item addgroup">Todos los Alumnos Nominados (.xlsx)</a>';
				echo '<a href="' . base_url() . '?c=excel&m=preescolar_excel_max_nominated" class="option-item addgroup">Alumnos con 3 o más Áreas de Desempeño (.xlsx)</a>';
			...
			foreach ( $schools as $school ) {
				echo '<span class="table-rows' . (($school_counter % 2)? ' odd':'') . '" id="schoolid_' . $school->school_id . '">';
					...
					echo '<span class="col-title col-tools">';
						echo '<a href="' . base_url() . '?c=excel&m=preescolar_make_school_excel&schoolID=' . $school->school_id . '" class="tool download" title="descargar archivo"></a>';
