<?php
		...
		echo '<span class="form-registeruser">';
			...
			echo '<span class="form-row">';
				echo '<span class="row-label">Zona supervisión<br />U.S.A.E.R.</span>';
			...
			echo '<span class="form-row">';
				...
				echo '<span class="row-field">';
					echo '<select name="register-usercrosee" id="register-usercrosee" class="fselect">';
						echo '<option value="0" selected="selected">-- Seleccione la C.R.O.S.E.E. a la que pertenece --</option>';
						echo '<option value="1">C.R.O.S.E.E. 1</option>';
						echo '<option value="2">C.R.O.S.E.E. 2</option>';
						echo '<option value="3">C.R.O.S.E.E. 3</option>';
						echo '<option value="4">C.R.O.S.E.E. 4</option>';
						echo '<option value="5">C.R.O.S.E.E. 5</option>';
					echo '</select>';
				echo '</span>';
				echo '<span class="clear"></span>';
			echo '</span>';
