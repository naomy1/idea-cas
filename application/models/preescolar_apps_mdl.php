<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Preescolar_apps_mdl extends CI_Model {
		...
		public function getStudentsAppQuestions () {
			...
			return $this->db->get_where($this->db_table, array('question_school_level' => 1))->result();
		}
		 ...
		 */
		 ...
		 public function get_apps () {
			...
			$this->db->where('app_school_level', 1);
