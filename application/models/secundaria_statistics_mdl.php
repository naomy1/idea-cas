<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Secundaria_statistics_mdl extends CI_Model {
		...
		public function get_teachers_counter () {
			return $this->db->get_where('users ', array('user_type' => 'teacher', 'user_school_level' => 3))->num_rows();
		}
		...
		public function get_schools_counter () {
			return $this->db->get_where('schools ', array('school_level' => 3))->num_rows();
		}
		// end: get_teachers_counter
		...
		public function get_groups_counter () {
			return $this->db->get_where('schools_groups ', array('group_school_level' => 3))->num_rows();
		}
		// end: get_teachers_counter
		...
		public function get_answers_counter () {
			$this->db->where('answer_school_level', 3);
